...
public class BeneficiaryController {
	...
	public String addBeneficiary(@RequestParam("beneficiaryName")String beneficiaryName ,@RequestParam("accountID")String beneficiaryAccountId,@RequestParam("ifscCode")String ifscCode,@RequestParam("userId")int id,Model model)
	{
	...
	public String deleteBeneficiary(@RequestParam("viewid")int id,@RequestParam("deleteid") int idToDelete,Model model)
	{
	...
	public String update(@RequestParam("id")int id,@RequestParam("editBeneficiaryId")int editBeneficiaryId,@RequestParam("editBeneficiaryName")String beneficiaryName,@RequestParam("editBeneficiaryAccountId")String beneficiaryAccountId,@RequestParam("editBeneficiaryIfscCode")String beneficiaryIfsc,Model model)
	{
